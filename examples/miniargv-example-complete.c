...
int complete_test (char *argv[], const miniargv_definition* argdef, const miniargv_definition* currentarg, const char* arg, int argparampos, void* callbackdata)
{
  const char* data[] = {
    "123",
    "456",
...
*/
  ...
  if (miniargv_completion(argv, argdef, NULL, NULL)) {
    return 0;
  }
