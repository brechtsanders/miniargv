...
TESTS_BIN = examples/miniargv-example-global$(BINEXT) examples/miniargv-example-local$(BINEXT) examples/miniargv-example-userdata$(BINEXT) examples/miniargv-example-cfgfile$(BINEXT) examples/miniargv-example-specifiedcfgfile$(BINEXT) examples/miniargv-example-complete$(BINEXT) examples/miniargv-test$(BINEXT)
...
ifdef DOXYGEN
	$(MKDIR) binarypackage_temp_$(OSALIAS)/doc
	$(CPDIR) doc/html binarypackage_temp_$(OSALIAS)/doc/
endif
	$(RM) miniargv-$(shell cat version)-$(OSALIAS).zip
