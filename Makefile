...
TESTS_BIN = examples/miniargv-example-global$(BINEXT) examples/miniargv-example-local$(BINEXT) examples/miniargv-example-userdata$(BINEXT) examples/miniargv-test$(BINEXT)
